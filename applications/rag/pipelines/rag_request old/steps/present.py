...
from applications.rag.pipelines.rag_request.configs import EmptyConfig
from applications.rag.pipelines.rag_request.models import GenerationResult
from libs.streampipe.observability import trace_action

logger = logging.getLogger("Pipeline.PresentResult")


@trace_action(step_name="present")

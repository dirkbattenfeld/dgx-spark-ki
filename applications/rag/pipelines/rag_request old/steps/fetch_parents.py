...
from applications.rag.pipelines.rag_request.configs import ParentDocConfig
from applications.rag.pipelines.rag_request.models import RerankResult, EnrichedResult, EnrichedHit
from libs.streampipe.observability import trace_action

logger = logging.getLogger("Pipeline.FetchParents")


@trace_action(step_name="fetch_parents")

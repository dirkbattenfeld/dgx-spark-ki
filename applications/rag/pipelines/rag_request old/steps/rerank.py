...
from applications.rag.pipelines.rag_request.configs import RerankConfig
from applications.rag.pipelines.rag_request.models import SearchResult, RerankResult, RerankHit
from libs.streampipe.observability import trace_action

logger = logging.getLogger("Pipeline.Rerank")


@trace_action(step_name="rerank")

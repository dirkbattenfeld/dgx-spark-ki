...
from applications.rag.pipelines.rag_request.configs import SearchQdrantConfig
from applications.rag.pipelines.rag_request.models import EmbeddedQuery, SearchResult, SearchHit
from libs.streampipe.observability import trace_action

logger = logging.getLogger("Pipeline.SearchQdrant")


@trace_action(step_name="search")
